...
export const VideiraLogoIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    {/* First swoosh */}
    <path d="M45 95 C 80 70, 85 40, 60 25" stroke="#FBBF24" strokeWidth="18" strokeLinecap="round"/>
    {/* Second swoosh */}
    <path d="M20 55 C 40 20, 80 25, 90 60" stroke="#FBBF24" strokeWidth="18" strokeLinecap="round"/>
  </svg>
);
...
export const RocketLaunchIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.63 2.18a14.98 14.98 0 00-2.17 6.16m12.12 6.16v4.8m-5.84-7.38a14.98 14.98 0 01-12.12 6.16A14.98 14.98 0 012.18 9.63a14.98 14.98 0 016.16-2.17m6.16 12.12a14.98 14.98 0 017.38-5.84m-7.38 5.84L10.5 14.37m4.09 4.09l4.09-4.09" />
    </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.153.274c-.273 0-.54-.022-.802-.067l-7.5-1.5a5.985 5.985 0 01-4.686-5.414l-1.5-7.5c-.045-.262-.067-.53-.067-.802a5.988 5.988 0 01.274-2.153c.174-.483.702-.98 1.202-.589L18.75 4.971z" />
  </svg>
);